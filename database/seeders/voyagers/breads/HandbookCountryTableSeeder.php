...
{
    private const TABLE_NAME = 'handbook_countries';
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Справочник: Страны',
            'display_name_plural' => 'Справочник: Страны',
            'icon' => 'voyager-book',
            'model_name' => 'App\\Models\\HandbookCountry',
            'controller' => '',
            'server_side' => 1,
