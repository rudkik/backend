...
class HandbookMenuTypeTableSeeder extends Seeder
{
    ...
    private const TABLE_NAME = 'handbook_menu_types';
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Справочник: Тип меню',
            'display_name_plural' => 'Справочник: Тип меню',
            'icon' => 'voyager-book',
            'model_name' => 'App\\Models\\HandbookMenuType',
            'controller' => '',
