...
{
    private const TABLE_NAME = 'handbook_regions';
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Справочник: Области',
            'display_name_plural' => 'Справочник: Области',
            'icon' => 'voyager-book',
            'model_name' => 'App\\Models\\HandbookRegion',
            'controller' => '',
            'server_side' => 1,
        ...
        DataRow::create([
            ...
            'type' => 'number',
            'display_name' => 'Справочник: Страны',
            'required' => 1,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
