...
|[rocketfirm911/php-fpm](https://registry.hub.docker.com/r/rocketfirm911/php-fpm)|latest|719MB|
|[postgres](https://registry.hub.docker.com/_/postgres)|latest|491MB|
...
|nginx|80 и 443|
|mariadb|3306|
|postgres|5432, но можно менять параметром EXTERNAL_DB_PORT в .env-файле|
|adminer|8080|
|mongo|27017|
|mongo-express|8081|
|redis|6379|
