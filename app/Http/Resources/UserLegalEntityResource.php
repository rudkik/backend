...
class UserLegalEntityResource extends BaseResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'user_type' => UserTypeConstant::getUserTypeApi($this->user_type),
            'activity' => new HandbookUserActivityResource($this->handbookUserActivity),
            'legal_entity' => UserLegalResource::collection($this->userLegals)
        ];
    }
}
